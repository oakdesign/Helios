...
-- NOTE: vehicle driver scripts must not access this or they may break in a future release
helios_impl = {}
...
-- empty driver that exports nothing by default
helios_impl.driverName = ""

-- handle incoming message from Helio
