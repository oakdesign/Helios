...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.Common
{
    ...
    public class DCSConfigurator2 : NotificationObject
    {
        ...
        // path to this interface's ExportFunctions.lua within our application pack
        ...
        public DCSConfigurator2(DCSInterface parent, string preferencesPrefix, string exportLuaPath, string exportFunctionsPath) 
        {
            _parent = parent;
        ...
        public bool GenerateExportLoader { 
            ...
            set
            {
                ...
                ConfigManager.SettingsManager.SaveSetting(_prefPrefix, "GenerateExportLoader", _generateExportLoader.ToString(CultureInfo.InvariantCulture));
            }
        }
