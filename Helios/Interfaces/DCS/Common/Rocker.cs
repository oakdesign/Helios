...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.Common
{
    ...
    public class Rocker : NetworkFunction
    {
        ...
        public Rocker(HeliosNetworkInterface sourceInterface, string deviceId, string button1Id, string button2Id, string releaseButtonId, string releaseButton2Id, string argId, string device, string name, bool vertical)
            : this(sourceInterface, deviceId, button1Id, button2Id, releaseButtonId, releaseButton2Id, argId, device, name, vertical, "1", "-1", "0", "%1d")
        {
        }

        public Rocker(HeliosNetworkInterface sourceInterface, string deviceId, string button1Id, string button2Id, string releaseButtonId, string releaseButton2Id, string argId, string device, string name, bool vertical, string push1Value, string push2Value, string releaseValue, string exportFormat)
