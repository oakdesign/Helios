...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.F16C
{
    ...
    public class F16CInterface : BaseUDPInterface
    {
            ...
            : base("DCS F-16C")
        {
            ...
            AddFunction(new FlagValue(this, "630", "CautionLights", "FLCS Fault", ""));             //    630, CautionLights.FLCS_FAULT)
            AddFunction(new FlagValue(this, "631", "CautionLights", "Engine Fault", ""));               //    631, CautionLights.ENGINE_FAULT)
            AddFunction(new FlagValue(this, "632", "CautionLights", "Avionics Fault", ""));             //    632, CautionLights.AVIONICS_FAULT)
            AddFunction(new FlagValue(this, "633", "CautionLights", "Seat Not Armed", ""));             //    633, CautionLights.SEAT_NOT_ARMED)
            AddFunction(new FlagValue(this, "634", "CautionLights", "Elec Sys", ""));               //    634, CautionLights.ELEC_SYS)
            AddFunction(new FlagValue(this, "635", "CautionLights", "Sec", ""));                //    635, CautionLights.SEC)
            AddFunction(new FlagValue(this, "636", "CautionLights", "Equip Hot", ""));              //    636, CautionLights.EQUIP_HOT)
            AddFunction(new FlagValue(this, "637", "CautionLights", "NWS Fail", ""));               //    637, CautionLights.NWS_FAIL)
            AddFunction(new FlagValue(this, "638", "CautionLights", "Probe Heat", ""));             //    638, CautionLights.PROBE_HEAT)
            AddFunction(new FlagValue(this, "639", "CautionLights", "Fuel Oil Hot", ""));               //    639, CautionLights.FUEL_OIL_HOT)
            AddFunction(new FlagValue(this, "640", "CautionLights", "Radar Alt", ""));              //    640, CautionLights.RADAR_ALT)
            AddFunction(new FlagValue(this, "641", "CautionLights", "Anti Skid", ""));              //    641, CautionLights.ANTI_SKID)
            AddFunction(new FlagValue(this, "642", "CautionLights", "CADC", ""));               //    642, CautionLights.CADC)
            AddFunction(new FlagValue(this, "643", "CautionLights", "Inlet Icing", ""));                //    643, CautionLights.INLET_ICING)
            AddFunction(new FlagValue(this, "644", "CautionLights", "IFF", ""));                //    644, CautionLights.IFF)
            AddFunction(new FlagValue(this, "645", "CautionLights", "Hook", ""));               //    645, CautionLights.HOOK)
            AddFunction(new FlagValue(this, "646", "CautionLights", "Stores Config", ""));              //    646, CautionLights.STORES_CONFIG)
            AddFunction(new FlagValue(this, "647", "CautionLights", "Overheat", ""));               //    647, CautionLights.OVERHEAT)
            AddFunction(new FlagValue(this, "648", "CautionLights", "Nuclear", ""));                //    648, CautionLights.NUCLEAR)
            AddFunction(new FlagValue(this, "649", "CautionLights", "OBOGS", ""));              //    649, CautionLights.OBOGS)
            AddFunction(new FlagValue(this, "650", "CautionLights", "ATF Not Engaged", ""));                //    650, CautionLights.ATF_NOT_ENGAGED)
            AddFunction(new FlagValue(this, "651", "CautionLights", "EEC", ""));                //    651, CautionLights.EEC)
            AddFunction(new FlagValue(this, "652", "CautionLights", "Lights Max", ""));             //    652, CautionLights.LIGHTS_MAX)
            AddFunction(new FlagValue(this, "653", "CautionLights", "Cabin Press", ""));                //    653, CautionLights.CABIN_PRESS)
            AddFunction(new FlagValue(this, "654", "CautionLights", "Fwd Fuel Low", ""));               //    654, CautionLights.FWD_FUEL_LOW)
            AddFunction(new FlagValue(this, "655", "CautionLights", "BUC", ""));                //    655, CautionLights.BUC)
            AddFunction(new FlagValue(this, "656", "CautionLights", "Lights Max 1", ""));             //    656, CautionLights.LIGHTS_MAX)
            AddFunction(new FlagValue(this, "657", "CautionLights", "Lights Max 2", ""));             //    657, CautionLights.LIGHTS_MAX)
            AddFunction(new FlagValue(this, "658", "CautionLights", "Aft Fuel Low", ""));               //    658, CautionLights.AFT_FUEL_LOW)
            AddFunction(new FlagValue(this, "659", "CautionLights", "Lights Max 3", ""));             //    659, CautionLights.LIGHTS_MAX)
            AddFunction(new FlagValue(this, "660", "CautionLights", "Lights Max 4", ""));             //    660, CautionLights.LIGHTS_MAX)
            AddFunction(new FlagValue(this, "661", "CautionLights", "Lights Max 5", ""));             //    661, CautionLights.LIGHTS_MAX)
            #endregion
            #region  Edge of glareshield
            AddFunction(new FlagValue(this, "117", "CautionLights", "Master Caution", ""));             //    117, CautionLights.MASTER_CAUTION)
            AddFunction(new FlagValue(this, "121", "CautionLights", "TF Fail", ""));                //    121, CautionLights.TF_FAIL)
            AddFunction(new FlagValue(this, "126", "CautionLights", "Eng Fire", ""));               //    126, CautionLights.ENG_FIRE)
            AddFunction(new FlagValue(this, "127", "CautionLights", "Engine", ""));             //    127, CautionLights.ENGINE)
            AddFunction(new FlagValue(this, "129", "CautionLights", "Hyd Oil Press", ""));              //    129, CautionLights.HYD_OIL_PRESS)
            AddFunction(new FlagValue(this, "130", "CautionLights", "FLCS", ""));               //    130, CautionLights.FLCS)
            AddFunction(new FlagValue(this, "131", "CautionLights", "Dbu On", ""));             //    131, CautionLights.DBU_ON)
            AddFunction(new FlagValue(this, "133", "CautionLights", "TO Ldg Config", ""));              //    133, CautionLights.TO_LDG_CONFIG)
            AddFunction(new FlagValue(this, "134", "CautionLights", "Canopy", ""));             //    134, CautionLights.CANOPY)
            AddFunction(new FlagValue(this, "135", "CautionLights", "Oxy Low", ""));                //    135, CautionLights.OXY_LOW)
            #endregion
            #region  AOA Indexer
            AddFunction(new FlagValue(this, "110", "CautionLights", "AoA Red", ""));                //    110, CautionLights.AOA_RED)
            AddFunction(new FlagValue(this, "111", "CautionLights", "AoA Green", ""));              //    111, CautionLights.AOA_GREEN)
            AddFunction(new FlagValue(this, "112", "CautionLights", "AoA Yellow", ""));             //    112, CautionLights.AOA_YELLOW)
            #endregion
            #region  LG Control Panel
            AddFunction(new FlagValue(this, "350", "CautionLights", "Gear Nose", ""));              //    350, CautionLights.GEAR_NOSE)
            AddFunction(new FlagValue(this, "351", "CautionLights", "Gear Left", ""));              //    351, CautionLights.GEAR_LEFT)
            AddFunction(new FlagValue(this, "352", "CautionLights", "Gear Right", ""));             //    352, CautionLights.GEAR_RIGHT)
            AddFunction(new FlagValue(this, "369", "CautionLights", "Gear Warning", ""));               //    369, CautionLights.GEAR_WARNING)
            #endregion
            #region  AR Status/NWS Indicator
            AddFunction(new FlagValue(this, "113", "CautionLights", "Rdy", ""));                //    113, CautionLights.RDY)
            AddFunction(new FlagValue(this, "114", "CautionLights", "AR NWS", ""));             //    114, CautionLights.AR_NWS)
            AddFunction(new FlagValue(this, "115", "CautionLights", "Disc", ""));               //    115, CautionLights.DISC)
            #endregion
            #region 
            AddFunction(new FlagValue(this, "157", "CautionLights", "Marker Beacon", ""));              //    157, CautionLights.MARKER_BEACON)
            #endregion
            #region  Eng Control Panel
            AddFunction(new FlagValue(this, "446", "CautionLights", "JFS Run", ""));                //    446, CautionLights.JFS_RUN)
            #endregion
            #region  EPU Control Panel
            AddFunction(new FlagValue(this, "524", "CautionLights", "Hydrazn", ""));                //    524, CautionLights.HYDRAZN)
            AddFunction(new FlagValue(this, "523", "CautionLights", "Air", ""));                //    523, CautionLights.AIR)
            AddFunction(new FlagValue(this, "526", "CautionLights", "EPU", ""));                //    526, CautionLights.EPU)
            #endregion
            #region  Elec Control Panel
            AddFunction(new FlagValue(this, "513", "CautionLights", "FLCS PMG", ""));               //    513, CautionLights.FLCS_PMG)
            AddFunction(new FlagValue(this, "512", "CautionLights", "Main Gen", ""));               //    512, CautionLights.MAIN_GEN)
            AddFunction(new FlagValue(this, "515", "CautionLights", "Stby Gen", ""));               //    515, CautionLights.STBY_GEN)
            AddFunction(new FlagValue(this, "517", "CautionLights", "EPU Gen", ""));                //    517, CautionLights.EPU_GEN)
            AddFunction(new FlagValue(this, "516", "CautionLights", "EPU PMG", ""));                //    516, CautionLights.EPU_PMG)
            AddFunction(new FlagValue(this, "519", "CautionLights", "TO FLCS", ""));                //    519, CautionLights.TO_FLCS)
            AddFunction(new FlagValue(this, "518", "CautionLights", "FLCS Rly", ""));               //    518, CautionLights.FLCS_RLY)
            AddFunction(new FlagValue(this, "521", "CautionLights", "ACFT Batt Fail", ""));             //    521, CautionLights.ACFT_BATT_FAIL)
            #endregion
            #region  Advance Mode Switch
            AddFunction(new FlagValue(this, "106", "CautionLights", "Active", ""));             //    106, CautionLights.ACTIVE)
            AddFunction(new FlagValue(this, "107", "CautionLights", "Stby", ""));               //    107, CautionLights.STBY)
            #endregion
            #region  FLCP
            AddFunction(new FlagValue(this, "570", "CautionLights", "FL Run", ""));             //    570, CautionLights.FL_RUN)
            AddFunction(new FlagValue(this, "571", "CautionLights", "FL Fail", ""));                //    571, CautionLights.FL_FAIL)
            #endregion
            #region  Test Switch Panel
            AddFunction(new FlagValue(this, "581", "CautionLights", "FLCS Pwr A", ""));             //    581, CautionLights.FLCS_PWR_A)
            AddFunction(new FlagValue(this, "582", "CautionLights", "FLCS Pwr B", ""));             //    582, CautionLights.FLCS_PWR_B)
            AddFunction(new FlagValue(this, "583", "CautionLights", "FLCS Pwr C", ""));             //    583, CautionLights.FLCS_PWR_C)
            AddFunction(new FlagValue(this, "584", "CautionLights", "FLCS Pwr D", ""));             //    584, CautionLights.FLCS_PWR_D)
            AddFunction(new FlagValue(this, "396", "RWRLights", "Search", ""));             //    396, RWRLights.SEARCH)
            AddFunction(new FlagValue(this, "398", "RWRLights", "Activity", ""));               //    398, RWRLights.ACTIVITY)
            AddFunction(new FlagValue(this, "423", "RWRLights", "Act Power", ""));              //    423, RWRLights.ACT_POWER)
            AddFunction(new FlagValue(this, "400", "RWRLights", "Alt Low", ""));                //    400, RWRLights.ALT_LOW)
            AddFunction(new FlagValue(this, "424", "RWRLights", "Alt", ""));                //    424, RWRLights.ALT)
            AddFunction(new FlagValue(this, "402", "RWRLights", "Power", ""));              //    402, RWRLights.POWER)
            AddFunction(new FlagValue(this, "142", "RWRLights", "Handoff Up", ""));             //    142, RWRLights.HANDOFF_UP)
            AddFunction(new FlagValue(this, "136", "RWRLights", "Handoff H", ""));              //    136, RWRLights.HANDOFF_H)
            AddFunction(new FlagValue(this, "144", "RWRLights", "Msl Launch", ""));             //    144, RWRLights.MSL_LAUNCH)
            AddFunction(new FlagValue(this, "146", "RWRLights", "Mode Pri", ""));               //    146, RWRLights.MODE_PRI)
            AddFunction(new FlagValue(this, "137", "RWRLights", "Mode Open", ""));              //    137, RWRLights.MODE_OPEN)
            #endregion
            #region rwr_Ship_U			= create_rwr_lights(148, RWRLights.SHIP_U)
            AddFunction(new FlagValue(this, "148", "RWRLights", "Ship Unknown", ""));               //    148, RWRLights.SHIP_UNKNOWN)
            #endregion
            #region rwr_Sys_On			= create_rwr_lights(150, RWRLights.SYSTEST_ON)
            AddFunction(new FlagValue(this, "150", "RWRLights", "Systest", ""));                //    150, RWRLights.SYSTEST)
            AddFunction(new FlagValue(this, "152", "RWRLights", "Tgtsep Up", ""));              //    152, RWRLights.TGTSEP_UP)
            AddFunction(new FlagValue(this, "138", "RWRLights", "Tgtsep Down", ""));                //    138, RWRLights.TGTSEP_DOWN)
            #endregion
            #region  Brightness 792
            AddFunction(new FlagValue(this, "792", "controllers", "Brtrwrlights", ""));             //    792, controllers.brtRwrLights)
            AddFunction(new FlagValue(this, "370", "CmdsLights", "No Go", ""));             //    370, CmdsLights.NO_GO)
            AddFunction(new FlagValue(this, "372", "CmdsLights", "Go", ""));                //    372, CmdsLights.GO)
            AddFunction(new FlagValue(this, "376", "CmdsLights", "Disp", ""));              //    376, CmdsLights.DISP)
            AddFunction(new FlagValue(this, "379", "CmdsLights", "Rdy", ""));               //    379, CmdsLights.RDY)
            AddFunction(new FlagValue(this, "788", "InternalLights", "Consoles Lt", ""));               //    788, InternalLights.Consoles_lt)
            AddFunction(new FlagValue(this, "787", "InternalLights", "Instpnl Lt", ""));                //    787, InternalLights.InstPnl_lt)
            AddFunction(new FlagValue(this, "790", "InternalLights", "Consolesflood Lt", ""));              //    790, InternalLights.ConsolesFlood_lt)
            AddFunction(new FlagValue(this, "791", "InternalLights", "Instpnlflood Lt", ""));               //    791, InternalLights.InstPnlFlood_lt)
