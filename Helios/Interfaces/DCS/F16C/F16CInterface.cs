    ...
    public class F16CInterface : BaseUDPInterface
    {
            ...
            : base("DCS F-16C")
        {
            ...
            AddFunction(Switch.CreateToggleSwitch(this, (int)devices.CONTROL_INTERFACE, (int)control_commands.StoresConfig, "358", "1.0", "CAT III", "0.0", "CAT I", "Control Interface", "STORES CONFIG Switch, CAT III/CAT I", "0.1f"));// default_2_position_tumb_small(_("STORES CONFIG Switch, CAT III/CAT I"),devices.CONTROL_INTERFACE, control_commands.StoresConfig,358)
                                                                                                                                                                                                                                          //AddFunction((this, (int)devices.CONTROL_INTERFACE, (int)control_commands.ApPitchAtt, " control_comma", "Control Interface", "Autopilot PITCH Switch, ATT HOLD/ A/P OFF/ ALT HOLD"));// springloaded_3_pos_tumb(_("Autopilot PITCH Switch, ATT HOLD/ A/P OFF/ ALT HOLD"),devices.CONTROL_INTERFACE, control_commands.ApPitchAtt, control_comma
                                                                                                                                                                                                                                          //AddFunction((this, (int)devices.CONTROL_INTERFACE, (int)control_commands.ApRoll, "108", "Control Interface", "Autopilot ROLL Switch, STRG SEL/ATT HOLD/HDG SEL"));// default_3_position_tumb_small(_("Autopilot ROLL Switch, STRG SEL/ATT HOLD/HDG SEL"),devices.CONTROL_INTERFACE, control_commands.ApRoll,108)
            ...
            AddFunction(Switch.CreateToggleSwitch(this, (int)devices.EXTLIGHTS_SYSTEM, (int)extlights_commands.PosFlash, "532", "1.0", "FLASH", "0.0", "STEADY", "External Lights System", "FLASH STEADY Switch, FLASH/STEADY", "0.1f"));// default_2_position_tumb_small(_("FLASH STEADY Switch, FLASH/STEADY"),devices.EXTLIGHTS_SYSTEM, extlights_commands.PosFlash,532)
                                                                                                                                                                                                                                         //AddFunction((this, (int)devices.EXTLIGHTS_SYSTEM, (int)extlights_commands.PosWingTail, "533", "External Lights System", "WING/TAIL Switch, BRT/OFF/DIM"));// default_3_position_tumb_small(_("WING/TAIL Switch, BRT/OFF/DIM"),devices.EXTLIGHTS_SYSTEM, extlights_commands.PosWingTail,533)
                                                                                                                                                                                                                                         //AddFunction((this, (int)devices.EXTLIGHTS_SYSTEM, (int)extlights_commands.PosFus, "534", "External Lights System", "FUSELAGE Switch, BRT/OFF/DIM"));// default_3_position_tumb_small(_("FUSELAGE Switch, BRT/OFF/DIM"),devices.EXTLIGHTS_SYSTEM, extlights_commands.PosFus,534)
            AddFunction(new Axis(this, (int)devices.EXTLIGHTS_SYSTEM, (int)extlights_commands.FormKn, "535", 0.01d, 0.0d, 1.0d, "External Lights System", "FORM Knob"));// default_axis_limited(_("FORM Knob"),devices.EXTLIGHTS_SYSTEM, extlights_commands.FormKn,535)
                                                                                                                                                                        //AddFunction((this, (int)devices.EXTLIGHTS_SYSTEM, (int)extlights_commands.Master, "0", "External Lights System", "MASTER Switch, OFF/ALL/A-C/FORM/NORM"));// multiposition_switch(_("MASTER Switch, OFF/ALL/A-C/FORM/NORM"),devices.EXTLIGHTS_SYSTEM, extlights_commands.Master,536, 5, 0.1, NOT_INVERSED, 0
            AddFunction(new Axis(this, (int)devices.EXTLIGHTS_SYSTEM, (int)extlights_commands.AerialRefuel, "537", 0.01d, 0.0d, 1.0d, "External Lights System", "AERIAL Refueling Knob"));// default_axis_limited(_("AERIAL REFUELING Knob"),devices.EXTLIGHTS_SYSTEM, extlights_commands.AerialRefuel,537)
                                                                                                                                                                                          //AddFunction((this, (int)devices.EXTLIGHTS_SYSTEM, (int)extlights_commands.LandingTaxi, "360", "External Lights System", "LANDING TAXI  Lights Switch, LANDING/OFF/TAXI"));// default_3_position_tumb_small(_("LANDING TAXI LIGHTS Switch, LANDING/OFF/TAXI"),devices.EXTLIGHTS_SYSTEM, extlights_commands.LandingTaxi,360)
            #endregion
            ...
            AddFunction(new Axis(this, (int)devices.CPTLIGHTS_SYSTEM, (int)cptlights_commands.InstPnlFlood, " NOT_REL", 0.01d, 0.0d, 1.0d, "Cockpit Lights System", "Flood INST PNL BRT Knob"));// default_axis_limited(_("FLOOD INST PNL BRT Knob"),devices.CPTLIGHTS_SYSTEM, cptlights_commands.InstPnlFlood,690, 0, 0.1, NOT_UPDATABLE, NOT_REL
                                                                                                                                                                                                //AddFunction((this, (int)devices.CPTLIGHTS_SYSTEM, (int)cptlights_commands.MalIndLtsDim, " cptlights_commands.", "Cockpit Lights System", "MAL & IND LTS Switch, BRT/Center/DIM"));// springloaded_3_pos_tumb_small(_("MAL & IND LTS Switch, BRT/Center/DIM"),devices.CPTLIGHTS_SYSTEM, cptlights_commands.MalIndLtsDim, cptlights_commands.
            #endregion
            #region Electric System
            //AddFunction((this, (int)devices.ELEC_INTERFACE, (int)elec_commands.MainPwrSw, " fal", "Elec Interface", "MAIN PWR Switch, MAIN PWR/BATT/OFF"));// default_3_position_tumb(_("MAIN PWR Switch, MAIN PWR/BATT/OFF"),devices.ELEC_INTERFACE, elec_commands.MainPwrSw,510, false, anim_speed_default, fal
            ...
            AddFunction(Switch.CreateToggleSwitch(this, (int)devices.ELEC_INTERFACE, (int)elec_commands.EPU_GEN_TestSw, "579", "1.0", "EPU", "0.0", "GEN", "Elec Interface", "EPU/GEN Test Switch, EPU/GEN /OFF", "0.1f"));// springloaded_2_pos_tumb_small(_("EPU/GEN Test Switch, EPU/GEN /OFF"),devices.ELEC_INTERFACE, elec_commands.EPU_GEN_TestSw,579)
                                                                                                                                                                                                                           //AddFunction((this, (int)devices.ELEC_INTERFACE, (int)elec_commands.ProbeHeatSw, "578", "Elec Interface", "PROBE HEAT Switch, PROBE HEAT/OFF/HEAT"));// default_3_position_tumb_small(_("PROBE HEAT Switch, PROBE HEAT/OFF/HEAT"),devices.ELEC_INTERFACE, elec_commands.ProbeHeatSw,578)
            ...
            AddFunction(Switch.CreateToggleSwitch(this, (int)devices.FUEL_INTERFACE, (int)fuel_commands.TankInertingSw, "557", "1.0", "TANK INERTING", "0.0", "OFF", "Fuel Interface", "TANK INERTING Switch, TANK INERTING /OFF", "0.1f"));// default_2_position_tumb(_("TANK INERTING Switch, TANK INERTING /OFF"),devices.FUEL_INTERFACE, fuel_commands.TankInertingSw,557)
                                                                                                                                                                                                                                            //AddFunction((this, (int)devices.FUEL_INTERFACE, (int)fuel_commands.EngineFeedSw, " NOT_INVERSE", "Fuel Interface", "Engine FEED Knob, OFF/NORM/AFT/FWD"));// multiposition_switch(_("ENGINE FEED Knob, OFF/NORM/AFT/FWD"),devices.FUEL_INTERFACE, fuel_commands.EngineFeedSw,556, 4, 0.1, NOT_INVERSE
            ...
            AddFunction(new Axis(this, (int)devices.ECS_INTERFACE, (int)ecs_commands.TempKnob, "0.3}", 0.01d, 0.0d, 1.0d, "ECS Interface", "TEMP Knob"));// default_axis_limited(_("TEMP Knob"),devices.ECS_INTERFACE, ecs_commands.TempKnob, 692, 0.0, 0.1, false, false, {-0.3,0.3})
                                                                                                                                                         //AddFunction((this, (int)devices.ECS_INTERFACE, (int)ecs_commands.AirSourceKnob, " anim_", "ECS Interface", "AIR SOURCE Knob, OFF/NORM/DUMP/RAM"));// multiposition_switch(_("AIR SOURCE Knob, OFF/NORM/DUMP/RAM"),devices.ECS_INTERFACE, ecs_commands.AirSourceKnob, 693, 4, 0.1, NOT_INVERSED, 0.0, anim_
            ...
            //AddFunction((this, (int)devices.ENGINE_INTERFACE, (int)engine_commands.EpuSw, "528", "Engine Interface", "EPU Switch, ON/NORM/OFF"));// default_3_position_tumb_small(_("EPU Switch, ON/NORM/OFF"),devices.ENGINE_INTERFACE, engine_commands.EpuSw,528)
            #endregion
            #region engine
            //AddFunction((this, (int)devices.ENGINE_INTERFACE, (int)engine_commands.EngAntiIceSw, "710", "Engine Interface", "Engine ANTI ICE Switch, ON/AUTO/OFF"));// default_3_position_tumb(_("Engine ANTI ICE Switch, ON/AUTO/OFF"),devices.ENGINE_INTERFACE, engine_commands.EngAntiIceSw,710)
            //AddFunction((this, (int)devices.ENGINE_INTERFACE, (int)engine_commands.JfsSwStart2, " engine_commands.JfsSwStar", "Engine Interface", "JFS Switch, START 1/OFF/START 2"));// springloaded_3_pos_tumb(_("JFS Switch, START 1/OFF/START 2"),devices.ENGINE_INTERFACE, engine_commands.JfsSwStart2, engine_commands.JfsSwStar
            ...
            AddFunction(Switch.CreateToggleSwitch(this, (int)devices.ENGINE_INTERFACE, (int)engine_commands.MaxPowerSw, "451", "1.0", "MAX POWER", "0.0", "OFF", "Engine Interface", "MAX POWER Switch (is inoperative), MAX POWER/OFF", "0.1f"));// default_2_position_tumb(_("MAX POWER Switch (is inoperative), MAX POWER/OFF"),devices.ENGINE_INTERFACE, engine_commands.MaxPowerSw,451)
                                                                                                                                                                                                                                                  //AddFunction((this, (int)devices.ENGINE_INTERFACE, (int)engine_commands.ABResetSwEngData, " engine_commands", "Engine Interface", "AB RESET Switch, AB RESET/NORM/ENG DATA"));// springloaded_3_pos_tumb(_("AB RESET Switch, AB RESET/NORM/ENG DATA"),devices.ENGINE_INTERFACE, engine_commands.ABResetSwEngData, engine_commands
            ...
            //AddFunction((this, (int)devices.OXYGEN_INTERFACE, (int)oxygen_commands.SupplyLever, " anim_speed_default", "OXYGEN Interface", "Supply Lever, PBG/ON/OFF"));// default_3_position_tumb_small(_("Supply Lever, PBG/ON/OFF"),devices.OXYGEN_INTERFACE, oxygen_commands.SupplyLever,728, false, anim_speed_default
            AddFunction(Switch.CreateToggleSwitch(this, (int)devices.OXYGEN_INTERFACE, (int)oxygen_commands.DiluterLever, "727", "1.0", "100 percent", "0.0", "NORM", "OXYGEN Interface", "Diluter Lever, 100 percent/NORM", "0.1f"));// default_2_position_tumb_small(_("Diluter Lever, 100 percent/NORM"),devices.OXYGEN_INTERFACE, oxygen_commands.DiluterLever,727)
                                                                                                                                                                                                                                      //AddFunction((this, (int)devices.OXYGEN_INTERFACE, (int)oxygen_commands.EmergencyLever, "726", "OXYGEN Interface", "Emergency Lever, EMERGENCY/NORMAL/TEST MASK"));// default_3_position_tumb_small(_("Emergency Lever, EMERGENCY/NORMAL/TEST MASK"),devices.OXYGEN_INTERFACE, oxygen_commands.EmergencyLever,726)
            #endregion
            ...
            AddFunction(Switch.CreateToggleSwitch(this, (int)devices.FCR, (int)fcr_commands.PwrSw, "672", "1.0", "FCR", "0.0", "OFF", "FCR", "FCR Switch, FCR/OFF", "0.1f"));// default_2_position_tumb(_("FCR Switch, FCR/OFF"),devices.FCR, fcr_commands.PwrSw, 672)
                                                                                                                                                                             //AddFunction((this, (int)devices.RALT, (int)ralt_commands.PwrSw, "673", "RALT", "RDR ALT Switch, RDR ALT/STBY/OFF"));// default_3_position_tumb(_("RDR ALT Switch, RDR ALT/STBY/OFF"),devices.RALT, ralt_commands.PwrSw, 673)
            #endregion
            ...
            AddFunction(Switch.CreateToggleSwitch(this, (int)devices.UFC, (int)ufc_commands.UFC_Sw, "718", "1.0", "UFC", "0.0", "OFF", "UFC", "UFC Switch, UFC/OFF", "0.1f"));// default_2_position_tumb(_("UFC Switch, UFC/OFF"),devices.UFC, ufc_commands.UFC_Sw,718)
                                                                                                                                                                              //AddFunction((this, (int)devices.MIDS, (int)mids_commands.PwrSw, " NO", "MIDS", "MIDS LVT Knob, ZERO/OFF/ON"));// multiposition_switch(_("MIDS LVT Knob, ZERO/OFF/ON"),devices.MIDS, mids_commands.PwrSw, 723, 3, 0.1, NOT_INVERSED, 0.0, anim_speed_default * 0.1, NO
                                                                                                                                                                              //AddFunction((this, (int)devices.INS, (int)ins_commands.ModeKnob, " anim_", "INS", "INS Knob, OFF/STOR HDG/NORM/NAV/CAL/INFLT ALIGN/ATT"));// multiposition_switch(_("INS Knob, OFF/STOR HDG/NORM/NAV/CAL/INFLT ALIGN/ATT"),devices.INS, ins_commands.ModeKnob, 719, 7, 0.1, NOT_INVERSED, 0.0, anim_
            ...
            //AddFunction((this, (int)devices.MMC, (int)mmc_commands.MasterArmSw, "105", "MMC", "MASTER ARM Switch, MASTER ARM/OFF/SIMULATE"));// default_3_position_tumb(_("MASTER ARM Switch, MASTER ARM/OFF/SIMULATE"),devices.MMC, mmc_commands.MasterArmSw,105)
            ...
            AddFunction(new PushButton(this, (int)devices.UFC, (int)ufc_commands.Wx, "187", "UFC", " FLIR Polarity Button, Wx"));// short_way_button(_("ICP FLIR Polarity Button, Wx"),devices.UFC, ufc_commands.Wx,187)
                                                                                                                                 //AddFunction((this, (int)devices.UFC, (int)ufc_commands.FLIR_GAIN_Sw, "189", "UFC", " FLIR GAIN/LEVEL Switch, GAIN/LVL/AUTO"));// default_3_position_tumb_small(_("ICP FLIR GAIN/LEVEL Switch, GAIN/LVL/AUTO"),devices.UFC, ufc_commands.FLIR_GAIN_Sw,189)
            ...
            AddFunction(new PushButton(this, (int)devices.UFC, (int)ufc_commands.IFF_IDENT, "125", "UFC", "IFF IDENT Button"));// short_way_button(_("IFF IDENT Button"),devices.UFC, ufc_commands.IFF_IDENT,125)
                                                                                                                               //AddFunction((this, (int)devices.UFC, (int)ufc_commands.RF_Sw, "100", "UFC", "RF Switch, SILENT/QUIET/NORM"));// default_3_position_tumb(_("RF Switch, SILENT/QUIET/NORM"),devices.UFC, ufc_commands.RF_Sw,100)
            #endregion
            #region HUD Remote Control Panel
            //AddFunction((this, (int)devices.MMC, (int)mmc_commands.VvVah, "675", "MMC", " Scales Switch, VV/VAH / VAH / OFF"));// default_3_position_tumb(_("HUD Scales Switch, VV/VAH / VAH / OFF"),devices.MMC, mmc_commands.VvVah,675)
            //AddFunction((this, (int)devices.MMC, (int)mmc_commands.AttFpm, "676", "MMC", " Flightpath Marker Switch, ATT/FPM / FPM / OFF"));// default_3_position_tumb(_("HUD Flightpath Marker Switch, ATT/FPM / FPM / OFF"),devices.MMC, mmc_commands.AttFpm,676)
            //AddFunction((this, (int)devices.MMC, (int)mmc_commands.DedData, "677", "MMC", " DED/PFLD Data Switch, DED / PFL / OFF"));// default_3_position_tumb_small(_("HUD DED/PFLD Data Switch, DED / PFL / OFF"),devices.MMC, mmc_commands.DedData,677)
            //AddFunction((this, (int)devices.MMC, (int)mmc_commands.DeprRet, "678", "MMC", " Depressible Reticle Switch, STBY / PRI / OFF"));// default_3_position_tumb(_("HUD Depressible Reticle Switch, STBY / PRI / OFF"),devices.MMC, mmc_commands.DeprRet,678)
            //AddFunction((this, (int)devices.MMC, (int)mmc_commands.Spd, "679", "MMC", " Velocity Switch, CAS / TAS / GND SPD"));// default_3_position_tumb_small(_("HUD Velocity Switch, CAS / TAS / GND SPD"),devices.MMC, mmc_commands.Spd,679)
            //AddFunction((this, (int)devices.MMC, (int)mmc_commands.Alt, "680", "MMC", " Altitude Switch, RADAR / BARO / AUTO"));// default_3_position_tumb_small(_("HUD Altitude Switch, RADAR / BARO / AUTO"),devices.MMC, mmc_commands.Alt,680)
            //AddFunction((this, (int)devices.MMC, (int)mmc_commands.Brt, "681", "MMC", " Brightness Control Switch, DAY / AUTO BRT / NIGHT"));// default_3_position_tumb_small(_("HUD Brightness Control Switch, DAY / AUTO BRT / NIGHT"),devices.MMC, mmc_commands.Brt,681)
            //AddFunction((this, (int)devices.MMC, (int)mmc_commands.Test, "682", "MMC", " TEST Switch, STEP / ON / OFF"));// default_3_position_tumb_small(_("HUD TEST Switch, STEP / ON / OFF"),devices.MMC, mmc_commands.Test,682)
            #endregion
            #region Audio Control Panels
            //AddFunction((this, (int)devices.INTERCOM, (int)intercom_commands.COM1_ModeKnob, " anim_sp", "InternalERCOM", "COMM 1 (UHF) Mode Knob"));// multiposition_switch(_("COMM 1 (UHF) Mode Knob"),devices.INTERCOM, intercom_commands.COM1_ModeKnob,434, 3, 0.5, NOT_INVERSED, 0.0, anim_sp
            //AddFunction((this, (int)devices.INTERCOM, (int)intercom_commands.COM2_ModeKnob, " anim_sp", "InternalERCOM", "COMM 2 (VHF) Mode Knob"));// multiposition_switch(_("COMM 2 (VHF) Mode Knob"),devices.INTERCOM, intercom_commands.COM2_ModeKnob,435, 3, 0.5, NOT_INVERSED, 0.0, anim_sp
            ...
            AddFunction(new Axis(this, (int)devices.INTERCOM, (int)intercom_commands.ILS_PowerKnob, "442", 0.01d, 0.0d, 1.0d, "InternalERCOM", "ILS Power Knob"));// default_axis_limited(_("ILS Power Knob"),devices.INTERCOM, intercom_commands.ILS_PowerKnob,442)
                                                                                                                                                                  //AddFunction((this, (int)devices.INTERCOM, (int)intercom_commands.HotMicCipherSw, "443", "InternalERCOM", "HOT MIC CIPHER Switch, HOT MIC / OFF / CIPHER"));// default_3_position_tumb_small(_("HOT MIC CIPHER Switch, HOT MIC / OFF / CIPHER"),devices.INTERCOM, intercom_commands.HotMicCipherSw,443)
            AddFunction(Switch.CreateToggleSwitch(this, (int)devices.INTERCOM, (int)intercom_commands.VMS_InhibitSw, "696", "1.0", "VOICE MESSAGE", "0.0", "INHIBIT", "InternalERCOM", "Voice Message Inhibit Switch, VOICE MESSAGE/INHIBIT", "0.1f"));// default_2_position_tumb_small(_("Voice Message Inhibit Switch, VOICE MESSAGE/INHIBIT"),devices.INTERCOM, intercom_commands.VMS_InhibitSw,696)
                                                                                                                                                                                                                                                       //AddFunction((this, (int)devices.INTERCOM, (int)intercom_commands.IFF_AntSelSw, "711", "InternalERCOM", "IFF ANT SEL Switch, LOWER/NORM/UPPER"));// default_3_position_tumb_small(_("IFF ANT SEL Switch, LOWER/NORM/UPPER"),devices.INTERCOM, intercom_commands.IFF_AntSelSw,711)
                                                                                                                                                                                                                                                       //AddFunction((this, (int)devices.INTERCOM, (int)intercom_commands.UHF_AntSelSw, "712", "InternalERCOM", "UHF ANT SEL Switch, LOWER/NORM/UPPER"));// default_3_position_tumb_small(_("UHF ANT SEL Switch, LOWER/NORM/UPPER"),devices.INTERCOM, intercom_commands.UHF_AntSelSw,712)
            #endregion
            #region UHF Backup Control Panel
            //AddFunction((this, (int)devices.UHF_CONTROL_PANEL, (int)uhf_commands.ChannelKnob, " anim_spe", "UHF Control Panel", "UHF CHAN Knob"));// multiposition_switch(_("UHF CHAN Knob"),devices.UHF_CONTROL_PANEL, uhf_commands.ChannelKnob,410, 20, 0.05, NOT_INVERSED, 0.0, anim_spe
            //AddFunction((this, (int)devices.UHF_CONTROL_PANEL, (int)uhf_commands.FreqSelector100Mhz, " NOT_INVERS", "UHF Control Panel", "UHF Manual Frequency Knob 100 MHz"));// multiposition_switch(_("UHF Manual Frequency Knob 100 MHz"),devices.UHF_CONTROL_PANEL, uhf_commands.FreqSelector100Mhz,411, 3, 0.1, NOT_INVERS
            //AddFunction((this, (int)devices.UHF_CONTROL_PANEL, (int)uhf_commands.FreqSelector10Mhz, " NOT_INVERSED", "UHF Control Panel", "UHF Manual Frequency Knob 10 MHz"));// multiposition_switch(_("UHF Manual Frequency Knob 10 MHz"),devices.UHF_CONTROL_PANEL, uhf_commands.FreqSelector10Mhz,412, 10, 0.1, NOT_INVERSED
            //AddFunction((this, (int)devices.UHF_CONTROL_PANEL, (int)uhf_commands.FreqSelector1Mhz, "0", "UHF Control Panel", "UHF Manual Frequency Knob 1 MHz"));// multiposition_switch(_("UHF Manual Frequency Knob 1 MHz"),devices.UHF_CONTROL_PANEL, uhf_commands.FreqSelector1Mhz,413, 10, 0.1, NOT_INVERSED, 0
            //AddFunction((this, (int)devices.UHF_CONTROL_PANEL, (int)uhf_commands.FreqSelector01Mhz, " NOT_INVERS", "UHF Control Panel", "UHF Manual Frequency Knob 0.1 MHz"));// multiposition_switch(_("UHF Manual Frequency Knob 0.1 MHz"),devices.UHF_CONTROL_PANEL, uhf_commands.FreqSelector01Mhz,414, 10, 0.1, NOT_INVERS
            //AddFunction((this, (int)devices.UHF_CONTROL_PANEL, (int)uhf_commands.FreqSelector0025Mhz, " NOT_INV", "UHF Control Panel", "UHF Manual Frequency Knob 0.025 MHz"));// multiposition_switch(_("UHF Manual Frequency Knob 0.025 MHz"),devices.UHF_CONTROL_PANEL, uhf_commands.FreqSelector0025Mhz,415, 4, 0.25, NOT_INV
            //AddFunction((this, (int)devices.UHF_CONTROL_PANEL, (int)uhf_commands.FunctionKnob, " anim_speed", "UHF Control Panel", "UHF Function Knob"));// multiposition_switch(_("UHF Function Knob"),devices.UHF_CONTROL_PANEL, uhf_commands.FunctionKnob,417, 4, 0.1, NOT_INVERSED, 0.0, anim_speed
            //AddFunction((this, (int)devices.UHF_CONTROL_PANEL, (int)uhf_commands.FreqModeKnob, " anim_speed_de", "UHF Control Panel", "UHF Mode Knob"));// multiposition_switch(_("UHF Mode Knob"),devices.UHF_CONTROL_PANEL, uhf_commands.FreqModeKnob,416, 3, 0.1, NOT_INVERSED, 0.0, anim_speed_de
            ...
            //AddFunction((this, (int)devices.IFF_CONTROL_PANEL, (int)iff_commands.CNI_Knob, " anim_speed_defa", "IFF Control Panel", "C & I Knob, UFC/BACKUP"));// multiposition_switch(_("C & I Knob, UFC/BACKUP"),devices.IFF_CONTROL_PANEL, iff_commands.CNI_Knob,542, 2, 1, NOT_INVERSED, 0.0, anim_speed_defa
            //AddFunction((this, (int)devices.IFF_CONTROL_PANEL, (int)iff_commands.MasterKnob, "0", "IFF Control Panel", "IFF MASTER Knob, OFF/STBY/LOW/NORM/EMER"));// multiposition_switch(_("IFF MASTER Knob, OFF/STBY/LOW/NORM/EMER"),devices.IFF_CONTROL_PANEL, iff_commands.MasterKnob,540, 5, 0.1, NOT_INVERSED, 0.0
            //AddFunction((this, (int)devices.IFF_CONTROL_PANEL, (int)iff_commands.M4CodeSw, "541", "IFF Control Panel", "IFF M-4 CODE Switch, HOLD/ A/B /ZERO"));// default_3_position_tumb(_("IFF M-4 CODE Switch, HOLD/ A/B /ZERO"),devices.IFF_CONTROL_PANEL, iff_commands.M4CodeSw,541)
            //AddFunction((this, (int)devices.IFF_CONTROL_PANEL, (int)iff_commands.M4ReplySw, "543", "IFF Control Panel", "IFF MODE 4 REPLY Switch, OUT/A/B"));// default_3_position_tumb(_("IFF MODE 4 REPLY Switch, OUT/A/B"),devices.IFF_CONTROL_PANEL, iff_commands.M4ReplySw,543)
            AddFunction(Switch.CreateToggleSwitch(this, (int)devices.IFF_CONTROL_PANEL, (int)iff_commands.M4MonitorSw, "544", "1.0", "OUT", "0.0", "AUDIO", "IFF Control Panel", "IFF MODE 4 MONITOR Switch, OUT/AUDIO", "0.1f"));// default_2_position_tumb_small(_("IFF MODE 4 MONITOR Switch, OUT/AUDIO"),devices.IFF_CONTROL_PANEL, iff_commands.M4MonitorSw,544)
                                                                                                                                                                                                                                  //AddFunction((this, (int)devices.IFF_CONTROL_PANEL, (int)iff_commands.EnableSw, "553", "IFF Control Panel", "IFF ENABLE Switch, M1/M3 /OFF/ M3/MS"));// default_3_position_tumb_small(_("IFF ENABLE Switch, M1/M3 /OFF/ M3/MS"),devices.IFF_CONTROL_PANEL, iff_commands.EnableSw,553)
                                                                                                                                                                                                                                  //AddFunction((this, (int)devices.IFF_CONTROL_PANEL, (int)iff_commands.M1M3Selector1_Dec, " iff_commands.M1M3Selector1", "IFF Control Panel", "IFF MODE 1 Selector Lever, DIGIT 1"));// springloaded_3_pos_tumb(_("IFF MODE 1 Selector Lever, DIGIT 1"),devices.IFF_CONTROL_PANEL, iff_commands.M1M3Selector1_Dec, iff_commands.M1M3Selector1
                                                                                                                                                                                                                                  //AddFunction((this, (int)devices.IFF_CONTROL_PANEL, (int)iff_commands.M1M3Selector2_Dec, " iff_commands.M1M3Selector2", "IFF Control Panel", "IFF MODE 1 Selector Lever, DIGIT 2"));// springloaded_3_pos_tumb(_("IFF MODE 1 Selector Lever, DIGIT 2"),devices.IFF_CONTROL_PANEL, iff_commands.M1M3Selector2_Dec, iff_commands.M1M3Selector2
                                                                                                                                                                                                                                  //AddFunction((this, (int)devices.IFF_CONTROL_PANEL, (int)iff_commands.M1M3Selector3_Dec, " iff_commands.M1M3Selector3", "IFF Control Panel", "IFF MODE 3 Selector Lever, DIGIT 1"));// springloaded_3_pos_tumb(_("IFF MODE 3 Selector Lever, DIGIT 1"),devices.IFF_CONTROL_PANEL, iff_commands.M1M3Selector3_Dec, iff_commands.M1M3Selector3
                                                                                                                                                                                                                                  //AddFunction((this, (int)devices.IFF_CONTROL_PANEL, (int)iff_commands.M1M3Selector4_Dec, " iff_commands.M1M3Selector4", "IFF Control Panel", "IFF MODE 3 Selector Lever, DIGIT 2"));// springloaded_3_pos_tumb(_("IFF MODE 3 Selector Lever, DIGIT 2"),devices.IFF_CONTROL_PANEL, iff_commands.M1M3Selector4_Dec, iff_commands.M1M3Selector4
            #endregion
            #region KY-58
            //AddFunction((this, (int)devices.KY58, (int)ky58_commands.KY58_ModeSw, " anim_speed_default", "KY58", "KY-58 MODE Knob, P/C/LD/RV"));// multiposition_switch(_("KY-58 MODE Knob, P/C/LD/RV"),devices.KY58, ky58_commands.KY58_ModeSw,705, 4, 0.1, NOT_INVERSED, 0.0, anim_speed_default
            AddFunction(new Axis(this, (int)devices.KY58, (int)ky58_commands.KY58_Volume, "1}", 0.01d, 0.0d, 1.0d, "KY58", "KY-58 VOLUME Knob"));// default_axis_limited(_("KY-58 VOLUME Knob"),devices.KY58, ky58_commands.KY58_Volume,708, 0.0, 0.1, false, false, {0,1})
                                                                                                                                                 //AddFunction((this, (int)devices.KY58, (int)ky58_commands.KY58_FillSw, " anim_spe", "KY58", "KY-58 FILL Knob, Z 1-5/1/2/3/4/5/6/Z ALL"));// multiposition_switch(_("KY-58 FILL Knob, Z 1-5/1/2/3/4/5/6/Z ALL"),devices.KY58, ky58_commands.KY58_FillSw,706, 8, 0.1, NOT_INVERSED, 0.0, anim_spe
                                                                                                                                                 //AddFunction((this, (int)devices.KY58, (int)ky58_commands.KY58_PowerSw, " anim_speed_defaul", "KY58", "KY-58 Power Knob, OFF/ON/TD"));// multiposition_switch(_("KY-58 Power Knob, OFF/ON/TD"),devices.KY58, ky58_commands.KY58_PowerSw,707, 3, 0.5, NOT_INVERSED, 0.0, anim_speed_defaul
                                                                                                                                                 //AddFunction((this, (int)devices.INTERCOM, (int)intercom_commands.PlainCipherSw, "701", "InternalERCOM", "PLAIN Cipher Switch, CRAD 1/PLAIN/CRAD 2"));// default_3_position_tumb_small(_("PLAIN Cipher Switch, CRAD 1/PLAIN/CRAD 2"),devices.INTERCOM, intercom_commands.PlainCipherSw,701)
                                                                                                                                                 ...
                                                                                                                                                 //AddFunction((this, (int)devices.INTERCOM, (int)intercom_commands.ZeroizeSw, "695", "InternalERCOM", "ZEROIZE Switch, OFP/OFF/DATA"));// default_3_position_tumb_small(_("ZEROIZE Switch, OFP/OFF/DATA"),devices.INTERCOM, intercom_commands.ZeroizeSw,695)
            #endregion
            #region HMCS
            ...
            AddFunction(Switch.CreateToggleSwitch(this, (int)devices.CMDS, (int)cmds_commands.FlExp, "368", "1.0", "ON", "0.0", "OFF", "CMDS", "FL Expendable Category Switch, ON/OFF", "0.1f"));// default_2_position_tumb_small(_("FL Expendable Category Switch, ON/OFF"),devices.CMDS, cmds_commands.FlExp,368)
                                                                                                                                                                                                 //AddFunction((this, (int)devices.CMDS, (int)cmds_commands.Prgm, " NOT_CY", "CMDS", "PROGRAM Knob, BIT/1/2/3/4"));// multiposition_switch(_("PROGRAM Knob, BIT/1/2/3/4"),devices.CMDS, cmds_commands.Prgm,377, 5, 0.1, NOT_INVERSED, 0.0, anim_speed_default, NOT_CY
                                                                                                                                                                                                 //AddFunction((this, (int)devices.CMDS, (int)cmds_commands.Mode, " anim_speed_defaul", "CMDS", "MODE Knob, OFF/STBY/MAN/SEMI/AUTO/BYP"));// multiposition_switch(_("MODE Knob, OFF/STBY/MAN/SEMI/AUTO/BYP"),devices.CMDS, cmds_commands.Mode,378, 6, 0.1, NOT_INVERSED, 0.0, anim_speed_defaul
            #endregion
            #region MFD Left
            ...
            AddFunction(new Axis(this, (int)devices.AAU34, (int)alt_commands.ZERO, " true", 0.01d, 0.0d, 1.0d, "AAU34", "Barometric Setting Knob"));// default_axis(_("Barometric Setting Knob"),devices.AAU34, alt_commands.ZERO, 62, 0, 0.1, true, true, true)
                                                                                                                                                    //AddFunction((this, (int)devices.AAU34, (int)alt_commands.ELEC, "60", "AAU34", "Mode Lever, Elec/OFF/PNEU"));// springloaded_3_pos_tumb(_("Mode Lever, ELEC/OFF/PNEU"),devices.AAU34, alt_commands.ELEC, alt_commands.PNEU, 60)
            #endregion
            #region SAI
            #endregion
            #region ADI
            ...
            AddFunction(Switch.CreateToggleSwitch(this, (int)devices.CPT_MECH, (int)cpt_commands.CanopyHandle, "600", "1.0", "UP", "0.0", "DOWN", "Cockpit MECH", "Canopy Handle, UP/DOWN", "0.1f"));// default_2_position_tumb(_("Canopy Handle, UP/DOWN"),devices.CPT_MECH, cpt_commands.CanopyHandle, 600)
                                                                                                                                                                                                     //AddFunction((this, (int)devices.CPT_MECH, (int)cpt_commands.SeatAdjSwitchDown, "786", "Cockpit MECH", "SEAT ADJ Switch, UP/OFF/DOWN"));// springloaded_3_pos_tumb_small(_("SEAT ADJ Switch, UP/OFF/DOWN"),devices.CPT_MECH, cpt_commands.SeatAdjSwitchDown, cpt_commands.SeatAdjSwitchUp, 786)
