...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.F16C
{
    ...
    /// <summary>
    /// Interaction logic for F16CInterfaceEditor.xaml
    /// </summary>
    public partial class F16CInterfaceEditor : HeliosInterfaceEditor
    {
        static F16CInterfaceEditor()
        {
            Type ownerType = typeof(F16CInterfaceEditor);
        ...
        {
            F16CInterfaceEditor editor = target as F16CInterfaceEditor;
        ...
        public F16CInterfaceEditor()
        {
            InitializeComponent();
            _bestDCSInstallType = 3;
            Configuration = new DCSConfigurator("DCS F-16C", DCSPath);
            ...
            Configuration.ExportFunctionsPath = "pack://application:,,,/Helios;component/Interfaces/DCS/F16C/ExportFunctions.lua";
        ...
        public static readonly DependencyProperty ConfigurationProperty =
            DependencyProperty.Register("Configuration", typeof(DCSConfigurator), typeof(F16CInterfaceEditor), new PropertyMetadata(null));
        ...
        public string DCSPath
        {
            get
            {
                ...
                if (_dcsPath == null)
                {
                    ...
                    {
                        --_bestDCSInstallType;
                        pathKey = Registry.CurrentUser.OpenSubKey(@"Software\Eagle Dynamics\DCS F16C");
                    }
                    ...
                    {
                        ConfigManager.LogManager.LogDebug("DCS F-16C Interface Editor - No DCS Installation Paths Found in registry");
        ...
        public void ForceDCSPath()
        {
            ...
            if (pathKey != null)
            {
                ...
                pathKey.Close();
                ConfigManager.LogManager.LogDebug("DCS F-16 Interface Editor - Found DCS Path (Path=\"" + _dcsPath + "\")");
            }
            else
            {
                _dcsPath = "";
                Configuration.AppPath = "";
                ConfigManager.LogManager.LogDebug("DCS F-16C Interface Editor - Forced DCS Install Type Path not found (Installation Type=\"" + Configuration.DCSInstallType + "\")");
            }
        }
        ...
        private void Configure_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show(Window.GetWindow(this), "DCS F-16C has been configured.");
            }
            else
            {
                MessageBox.Show(Window.GetWindow(this), "Error updating DCS F-16C configuration.  Please do one of the following and try again:\n\nOption 1) Run Helios as Administrator\nOption 2) Install DCS outside the Program Files Directory\nOption 3) Disable UAC.");
            }
        }
