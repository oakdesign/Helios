...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.FA18C
{
    ...
    public class FA18CInterface : BaseUDPInterface
    {
            ...
            : base("DCS F/A-18C")
        {
            ...
            AddFunction(new Switch(this, CPT_LIGTHS, "419", new SwitchPosition[] { new SwitchPosition("1.0", "NVG", "3004"), new SwitchPosition("0.0", "NITE", "3004"), new SwitchPosition("-1.0", "DAY", "3004") }, "Cockpit Lights", "MODE Switch", "%0.1f"));    // elements["pnt_419"]     = default_3_position_tumb(_("MODE Switch, NVG/NITE/DAY"),           devices.CPT_LIGTHS,     cptlights_commands.ModeSw,      419)
