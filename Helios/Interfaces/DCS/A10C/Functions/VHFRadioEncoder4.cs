...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.A10C.Functions
{
    ...
    class VHFRadioEncoder4 : Axis
    {
		...
		public VHFRadioEncoder4(HeliosNetworkInterface sourceInterface, string deviceId, string buttonId, string argId, double argValue, double argMin, double argMax, string device, string name)
