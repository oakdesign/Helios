...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.A10C.Functions
{
    ...
    class VHFPresetSelector : Axis
    {
		...
		public VHFPresetSelector(HeliosNetworkInterface sourceInterface, string deviceId, string buttonId, string argId, double argValue, double argMin, double argMax, string device, string name)
