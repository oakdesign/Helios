...
namespace GadrocsWorkshop.Helios.Gauges.F16C.ADI
{
    ...
    [HeliosControl("Helios.F16C.ADI", "ADI", "F-16C", typeof(GaugeRenderer))]
    public class ADI : BaseGauge
    {
            ...
            : base("ADI", new Size(350, 350))
        {
            ...
            _ball = new GaugeNeedle("{Helios}/Gauges/F-16C/ADI/adi_ball.xaml", new Point(175d, 175d), new Size(225d, 1350d), new Point(112.5d, 677d));
            ...
            _ilsHorizontalNeedle = new GaugeNeedle("{Helios}/Gauges/F-16C/ADI/adi_ils_bar.xaml", new Point(175d, 175d), new Size(189d, 6d), new Point(95d, 4d), 90d);
            _ilsHorizontalNeedle.VerticalOffset = _ilsCalibration.Interpolate(1d);
            Components.Add(_ilsHorizontalNeedle);

            _ilsVerticalNeedle = new GaugeNeedle("{Helios}/Gauges/F-16C/ADI/adi_ils_bar.xaml", new Point(175d, 175d), new Size(189d, 6d), new Point(95d, 4d));
            _ilsVerticalNeedle.VerticalOffset = _ilsCalibration.Interpolate(1d);
            Components.Add(_ilsVerticalNeedle);

            Components.Add(new GaugeImage("{Helios}/Gauges/F-16C/ADI/adi_inner_ring.xaml", new Rect(0d, 0d, 350d, 350d)));

            _auxFlagImage = new GaugeImage("{Helios}/Gauges/F-16C/ADI/adi_aux_flag.xaml", new Rect(0d, 0d, 350d, 350d));
            _auxFlagImage.IsHidden = true;
            Components.Add(_auxFlagImage);

            _offFlagImage = new GaugeImage("{Helios}/Gauges/F-16C/ADI/adi_off_flag.xaml", new Rect(0d, 0d, 350d, 350d));
            _offFlagImage.IsHidden = true;
            Components.Add(_offFlagImage);

            _gsFlagImage = new GaugeImage("{Helios}/Gauges/F-16C/ADI/adi_gs_flag.xaml", new Rect(0d, 0d, 350d, 350d));
            _gsFlagImage.IsHidden = true;
            Components.Add(_gsFlagImage);

            _locFlagImage = new GaugeImage("{Helios}/Gauges/F-16C/ADI/adi_loc_flag.xaml", new Rect(0d, 0d, 350d, 350d));
            _locFlagImage.IsHidden = true;
            Components.Add(_locFlagImage);

            Components.Add(new GaugeImage("{Helios}/Gauges/F-16C/ADI/adi_outer_ring.xaml", new Rect(0d, 0d, 350d, 350d)));

            _ilsScaleNeedle = new GaugeNeedle("{Helios}/Gauges/F-16C/ADI/adi_ils_scale_needle.xaml", new Point(30d, 174d), new Size(14d, 12d), new Point(1d, 6d));
            Components.Add(_ilsScaleNeedle);

            _slipBallCalibration = new CalibrationPointCollectionDouble(-1d, -26d, 1d, 26d);

            _slipBallNeedle = new GaugeNeedle("{Helios}/Gauges/F-16C/ADI/adi_slip_ball.xaml", new Point(175d, 313d), new Size(10d, 10d), new Point(5d, 5d));
            Components.Add(_slipBallNeedle);

            Components.Add(new GaugeImage("{Helios}/Gauges/F-16C/ADI/adi_guides.xaml", new Rect(0d, 0d, 350d, 350d)));

            Components.Add(new GaugeImage("{Helios}/Gauges/F-16C/ADI/adi_bezel.png", new Rect(0d, 0d, 350d, 350d)));
