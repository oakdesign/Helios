...
namespace GadrocsWorkshop.Helios.Gauges.F16C.RPM
{
    using GadrocsWorkshop.Helios.ComponentModel;
    using System;
    using System.Windows;

    [HeliosControl("Helios.F16C.RPM", "RPM", "F-16C", typeof(GaugeRenderer))]
    public class RPM : BaseGauge
    {
            ...
            : base("RPM", new Size(360, 360))
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F16C/RPM/rpm_faceplate.xaml", new Rect(30d, 30d, 300d, 300d)));

            _needle = new GaugeNeedle("{Helios}/Gauges/F16C/RPM/rpm_needle.xaml", new Point(180d, 180d), new Size(60d, 144d), new Point(30d, 114d));
