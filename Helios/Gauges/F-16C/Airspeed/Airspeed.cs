...
namespace GadrocsWorkshop.Helios.Gauges.F16C.Airspeed
{
    using GadrocsWorkshop.Helios.ComponentModel;
    using System;
    using System.Windows;

    [HeliosControl("Helios.F16C.Airspeed", "Airspeed", "F-16C", typeof(GaugeRenderer))]
    public class Airspeed : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{Helios}/Gauges/F-16C/Airspeed/asi_faceplate.xaml", new Rect(32d, 38d, 300d, 300d)));
            ...
            _machRing = new GaugeNeedle("{Helios}/Gauges/F-16C/Airspeed/asi_inner_faceplate.xaml", new Point(182d, 188d), new Size(188d, 188d), new Point(94d, 94d), -90d);
            ...
            _needle = new GaugeNeedle("{Helios}/Gauges/F-16C/Airspeed/asi_needle.xaml", new Point(182d, 188d), new Size(300d, 300d), new Point(150d, 150d), -90d);
            Components.Add(_needle);

            Components.Add(new GaugeImage("{Helios}/Gauges/F-16C/Common/f16_gauge_bezel.png", new Rect(0d, 0d, 364d, 376d)));
