...
namespace GadrocsWorkshop.Helios.Gauges.F16C.FuelFlow
{
    ...
    [HeliosControl("Helios.F16C.FuelFLow", "Fuel Flow", "F-16C", typeof(GaugeRenderer))]
    public class FuelFlow : BaseGauge
    {
            ...
            : base("Fuel Flow", new Size(220, 204))
        {
            ...
            _drum = new GaugeDrumCounter("{Helios}/Gauges/F16C/Common/drum_tape.xaml", new Point(30d, 79d), "##%00", new Size(10d, 15d), new Size(32d, 48d));
            _drum.Clip = new RectangleGeometry(drumRect);
            Components.Add(_drum);

            Components.Add(new GaugeImage("{Helios}/Gauges/F16C/FuelFlow/fuelflow_bezel.png", new Rect(0d, 0d, 220d, 204d)));
            Components.Add(new GaugeImage("{Helios}/Gauges/F16C/FuelFlow/fuelflow_labels.xaml", new Rect(0d, 0d, 220d, 204d)));
