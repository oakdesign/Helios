...
namespace GadrocsWorkshop.Helios.Gauges.F16C.HSI
{
    ...
    [HeliosControl("Helios.F16C.HSI", "HSI", "F-16C", typeof(GaugeRenderer))]
    public class HSI : BaseGauge
    {
            ...
            : base("HSI", new Size(350, 350))
        {
            ...
            _milesDrum = new GaugeDrumCounter("{Helios}/Gauges/F16C/Common/drum_tape.xaml", new Point(46, 60), "##%", new Size(10d, 15d), new Size(10d, 15d));
            _milesDrum.Clip = new RectangleGeometry(new Rect(46d, 60d, 30d, 15d));
            Components.Add(_milesDrum);

            _courseDrum = new GaugeDrumCounter("{Helios}/Gauges/F16C/Common/drum_tape.xaml", new Point(279, 60), "##%", new Size(10d, 15d), new Size(10d, 15d));
            _courseDrum.Clip = new RectangleGeometry(new Rect(279d, 60d, 30d, 15d));
            Components.Add(_courseDrum);

            _compassNeedle = new GaugeNeedle("{Helios}/Gauges/F16C/HSI/hsi_compass.xaml", new Point(175, 184), new Size(243, 243), new Point(121.5, 121.5));
            Components.Add(_compassNeedle);

            _dmeFlagImage = new GaugeImage("{Helios}/Gauges/F16C/HSI/hsi_dme_flag.xaml", new Rect(35, 64, 37, 10));
            _dmeFlagImage.IsHidden = true;
            Components.Add(_dmeFlagImage);

            _courseFlagNeedle = new GaugeNeedle("{Helios}/Gauges/F16C/HSI/hsi_course_flag.xaml", new Point(175, 184), new Size(350, 350), new Point(175, 184));
            _courseFlagNeedle.IsHidden = true;
            Components.Add(_courseFlagNeedle);

            _toFlagNeedle = new GaugeNeedle("{Helios}/Gauges/F16C/HSI/hsi_to_flag.xaml", new Point(175, 184), new Size(350, 350), new Point(175, 184));
            _toFlagNeedle.IsHidden = true;
            Components.Add(_toFlagNeedle);

            _fromFlagNeedle = new GaugeNeedle("{Helios}/Gauges/F16C/HSI/hsi_from_flag.xaml", new Point(175, 184), new Size(350, 350), new Point(175, 184));
            _fromFlagNeedle.IsHidden = true;
            Components.Add(_fromFlagNeedle);

            _deviationCard = new GaugeNeedle("{Helios}/Gauges/F16C/HSI/hsi_deviation_card.xaml", new Point(175, 184), new Size(183, 183), new Point(91.5, 91.5));
            Components.Add(_deviationCard);

            _deviationNeedle = new GaugeNeedle("{Helios}/Gauges/F16C/HSI/hsi_deviation_needle.xaml", new Point(175, 184), new Size(4, 149), new Point(1.5, 74.5));
            Components.Add(_deviationNeedle);

            _desiredCourseNeedle = new GaugeNeedle("{Helios}/Gauges/F16C/HSI/hsi_course_needle_f16.xaml", new Point(175, 184), new Size(12, 207), new Point(6, 103.5));
            Components.Add(_desiredCourseNeedle);

            Components.Add(new GaugeImage("{Helios}/Gauges/F16C/HSI/hsi_faceplate.xaml", new Rect(0, 0, 350, 350)));

            _headingBug = new GaugeNeedle("{Helios}/Gauges/F16C/HSI/hsi_heading_bug.xaml", new Point(175, 184), new Size(22, 9), new Point(11, 130.5));
            Components.Add(_headingBug);

            _bearingNeedle = new GaugeNeedle("{Helios}/Gauges/F16C/HSI/hsi_bearing_needle_f16.xaml", new Point(175, 184), new Size(11, 256), new Point(6, 128));
            Components.Add(_bearingNeedle);

            _offFlagImage = new GaugeImage("{Helios}/Gauges/F16C/HSI/hsi_off_flag.xaml", new Rect(246, 116, 77, 131));
            _offFlagImage.IsHidden = true;
            Components.Add(_offFlagImage);

            Components.Add(new GaugeImage("{Helios}/Gauges/F16C/HSI/hsi_bezel.png", new Rect(0, 0, 350, 350)));
