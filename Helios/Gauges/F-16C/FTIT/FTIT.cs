...
namespace GadrocsWorkshop.Helios.Gauges.F16C.FTIT
{
    using GadrocsWorkshop.Helios.ComponentModel;
    using System;
    using System.Windows;

    [HeliosControl("Helios.F16.FTIT", "FTIT", "F-16C", typeof(GaugeRenderer))]
    public class FTIT : BaseGauge
    {
            ...
            : base("FTIT", new Size(360, 360))
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F16C/FTIT/ftit_faceplate.xaml", new Rect(30d, 30d, 300d, 300d)));

            _needle = new GaugeNeedle("{Helios}/Gauges/F16C/FTIT/ftit_needle.xaml", new Point(180d, 180d), new Size(60d, 144d), new Point(30d, 114d), 90d);
