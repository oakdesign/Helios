...
namespace GadrocsWorkshop.Helios.Gauges.F16C.OilPressure
{
    using GadrocsWorkshop.Helios.ComponentModel;
    using System;
    using System.Windows;

    [HeliosControl("Helios.F16C.OilPressure", "Oil Pressure", "F-16C", typeof(GaugeRenderer))]
    public class OilPressure : BaseGauge
    {
            ...
            : base("Oil Pressure", new Size(360, 360))
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F16C/OilPressure/oil_faceplate.xaml", new Rect(30d, 30d, 300d, 300d)));

            _needle = new GaugeNeedle("{Helios}/Gauges/F16C/OilPressure/oil_needle.xaml", new Point(180d, 180d), new Size(60d, 144d), new Point(30d, 114d), 110d);
            _needle.Rotation = _needleCalibration.Interpolate(0);
            Components.Add(_needle);

            Components.Add(new GaugeImage("{Helios}/Gauges/F16C/Common/f16_engine_bezel.png", new Rect(0d, 0d, 360d, 360d)));
