...
namespace GadrocsWorkshop.Helios.Gauges.F16C.Trim
{
    ...
    [HeliosControl("Helios.F16C.RollTrim", "Roll Trim", "F-16C", typeof(GaugeRenderer))]
    public class RollTrim : BaseGauge
    {
            ...
            : base("Trim", new Size(100, 200))
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F16C/Trim/rolltrim_faceplate.xaml", new Rect(0d, 0d, 100d, 200d)));

            _needle = new GaugeNeedle("{Helios}/Gauges/F16C/Trim/rolltrim_needle.xaml", new Point(93d, 100d), new Size(90d, 14d), new Point(83d, 7d));
