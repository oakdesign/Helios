...
namespace GadrocsWorkshop.Helios.Gauges.F16C.Trim
{
    using GadrocsWorkshop.Helios.ComponentModel;
    using System;
    using System.Windows;

    [HeliosControl("Helios.F16C.PitchTrim", "Pitch Trim", "F-16C", typeof(GaugeRenderer))]
    public class PitchTrim : BaseGauge
    {
            ...
            : base("Trim", new Size(200, 100))
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F16C/Trim/pitchtrim_faceplate.xaml", new Rect(0d, 0d, 200d, 100d)));

            _needle = new GaugeNeedle("{Helios}/Gauges/F16C/Trim/pitchtrim_needle.xaml", new Point(100d, 7d), new Size(14d, 90d), new Point(7d, 7d));
