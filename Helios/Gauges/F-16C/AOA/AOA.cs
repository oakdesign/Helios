...
namespace GadrocsWorkshop.Helios.Gauges.F16C.AOA
{
    ...
    [HeliosControl("Helios.F16C.AOA", "AOA", "F-16C", typeof(GaugeRenderer))]
    public class AOA : BaseGauge
    {
        ...
        {
            _aoaNeedle = new GaugeNeedle("{Helios}/Gauges/F16C/AOA/aoa_tape.xaml", new Point(110, 226), new Size(130, 1482), new Point(65, 741));
            _aoaNeedle.Clip = new RectangleGeometry(new Rect(55d, 86d, 130d, 280d));
            Components.Add(_aoaNeedle);

            _offFlagImage = new GaugeImage("{Helios}/Gauges/F16C/AOA/aoa_off_flag.xaml", new Rect(55d, 84d, 110d, 282d));
            _offFlagImage.IsHidden = true;
            Components.Add(_offFlagImage);

            Components.Add(new GaugeImage("{Helios}/Gauges/F16C/AOA/aoa_faceplate.xaml", new Rect(0, 0, 220, 452)));

            Components.Add(new GaugeImage("{Helios}/Gauges/F16C/AOA/aoa_bezel.png", new Rect(0, 0, 220, 452)));
