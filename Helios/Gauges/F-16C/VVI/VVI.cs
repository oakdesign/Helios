...
namespace GadrocsWorkshop.Helios.Gauges.F16C.VVI
{
    ...
    [HeliosControl("Helios.F16C.VVI", "VVI", "F-16C", typeof(GaugeRenderer))]
    public class VVI : BaseGauge
    {
        ...
        {
            _vviTape = new GaugeNeedle("{Helios}/Gauges/F-16C/VVI/vvi_tape.xaml", new Point(110, 226), new Size(130, 1960), new Point(65, 980));
            _vviTape.Clip = new RectangleGeometry(new Rect(55d, 86d, 130d, 280d));
            Components.Add(_vviTape);

            _offFlagImage = new GaugeImage("{Helios}/Gauges/F-16C/VVI/vvi_off_flag.xaml", new Rect(55d, 84d, 111d, 282d));
            _offFlagImage.IsHidden = true;
            Components.Add(_offFlagImage);

            Components.Add(new GaugeImage("{Helios}/Gauges/F-16C/VVI/vvi_faceplate.xaml", new Rect(0, 0, 220, 452)));

            Components.Add(new GaugeImage("{Helios}/Gauges/F-16C/VVI/vvi_bezel.png", new Rect(0, 0, 220, 452)));
