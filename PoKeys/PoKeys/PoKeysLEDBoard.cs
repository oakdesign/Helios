...
namespace GadrocsWorkshop.Helios.Interfaces.PoKeys
{
    ...
    using global::PoKeys;
    using global::PoKeys.Events;
    using System;
    using System.Globalization;

    [HeliosInterface("Helios.PoKeys.LedBoard", "PoKeys Advanced LED Controller", typeof(PoKeysLedBoardEditor), Factory = typeof(PoKeysInterfaceFactory))]
    public class PoKeysLEDBoard : PoKeysInterface
    {
        ...
        public override Int32 SerialNumber
        {
            ...
            set
            {
                if (!_serialNumber.Equals(value))
                {
                    ...
                    Name = "PoKeys LED Board (" + _serialNumber + ")";
                }
            }
        }
